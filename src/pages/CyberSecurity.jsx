  ...
  return (
    <>
      ...
      <div className="mt-40">
        <div
          data-aos="fade-right"
          className="flex justify-center w-1/2 mt-20 ml-20 items-center border-left  border-green-500"
        >
          <img
            className="border-l-4 w-[18vw] h-[18vh] pl-4 border-green-500"
          ...
          <div className="text-left ml-8">
            ...
            <p className="text-white text-xl ">
              Understand Ethial hacking and get started with your cybersecurity
              journey !{" "}
            </p>
        ...
        <div className="flex justify-end">
          <div
            data-aos="fade-left"
            className="flex justify-end w-1/2 mt-20 mr-20 items-center border-left  border-green-500"
          >
            ...
            <img
              className="border-r-4 pr-4 w-[16vw] h-[18vh] border-green-500 "
        ...
        <div className="flex justify-end">
          ...
          >
            ...
            <img
              className="border-r-4 w-[16vw] h-[18vh] pr-4 border-green-500 "
        ...
        >
          <img
            className="border-l-4 pl-4  w-[16vw] h-[18vh] border-green-500"
